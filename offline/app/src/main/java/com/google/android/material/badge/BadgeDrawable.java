...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (a.hasValue(R.styleable.Badge_badgeRadius)) {
            this.badgeRadius = (float) a.getDimensionPixelSize(R.styleable.Badge_badgeRadius, (int) this.badgeRadius);
        }
        if (a.hasValue(R.styleable.Badge_badgeWidePadding)) {
            this.badgeWidePadding = (float) a.getDimensionPixelSize(R.styleable.Badge_badgeWidePadding, (int) this.badgeWidePadding);
        }
        if (a.hasValue(R.styleable.Badge_badgeWithTextRadius)) {
            this.badgeWithTextRadius = (float) a.getDimensionPixelSize(R.styleable.Badge_badgeWithTextRadius, (int) this.badgeWithTextRadius);
        }
        a.recycle();
    }
